...
const HomeScreenStyle = StyleSheet.create({
    ...
    button: { borderRadius: 20, backgroundColor: Colors.orange, padding: 10, justifyContent: 'center', alignItems: 'center',marginTop:'10%',width:'80%' },
    button_text: { color: Colors.white, fontWeight: "bold", textAlign: "center",fontSize:16 },
